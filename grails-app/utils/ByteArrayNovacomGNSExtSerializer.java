 ...
 * @since 2.0
 */
public class ByteArrayNovacomGNSExtSerializer extends AbstractByteArraySerializer {
	...
	/**
	 * Constructs the serializer using {@link #HEADER_SIZE_UNSIGNED_SHORT}
	 */
	public ByteArrayNovacomGNSExtSerializer() {
		this(HEADER_SIZE_UNSIGNED_SHORT);
	}
	 ...
	 * @param headerSize
	 */
	public ByteArrayNovacomGNSExtSerializer(int headerSize) {
	...
	public byte[] deserialize(InputStream inputStream) throws IOException {
		int messageLength = 0;
		boolean isSecondMessage = false;
		while (messageLength==0){
			messageLength = this.readHeader(inputStream);
			if (messageLength==0) {
